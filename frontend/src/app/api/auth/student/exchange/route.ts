...
export async function POST(req: NextRequest) {
    try {
        ...
        const jwt = signStudentJwt({ rosterId: inv.rosterId, instructorId: inv.ownerId, courseId: inv.courseId || undefined, email: ssoEmail, name: ssoName }, { expiresInSec: 60 * 60 * 24 * 7 });
